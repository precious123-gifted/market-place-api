...
const handler = async (req: NextApiRequest, res: NextApiResponse) => {
  try {
    ...
    if (req.method === "POST") {
        ...
        user.save()
          .then((data: IUser) => {
            ...
            return res.status(201)
              .setHeader('Access-Control-Allow-Origin', 'https://market-place-1gtp.vercel.app/SchoolSignUp') // Replace with your domain name
              .json({
                success: true,
                user
              })
      ...
      res.setHeader('Access-Control-Allow-Origin', 'https://market-place-1gtp.vercel.app/SchoolSignUp'); // Replace with your domain name
